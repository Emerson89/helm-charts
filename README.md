...
![Version: 2.2.2](https://img.shields.io/badge/Version-2.2.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.23.0](https://img.shields.io/badge/AppVersion-1.23.0-informational?style=flat-square)
...
| letsencrypt.email | string | `"email@example.com"` | Email use cluster Issuer |
| letsencrypt.enabled | bool | `false` | Enable create Cluster Issuer |
| letsencrypt.solvers | list | `[{"http01":{"ingress":{"ingressClassName":"nginx"}}}]` | Solvers options ##https://cert-manager.io/docs/configuration/acme/ |
...
| serviceAccount.name | string | `""` | If false Use name to use an already created service account |
...
| shareProcessNamespace | bool | `false` | Define ShareProcessNamespace |
| statefulset | bool | `false` | Type Statefulset  |
| tolerations | list | `[]` | Toleration labels for pod assignment |
| topologySpreadConstraints | list | `[]` | Define topologySpreadConstraints |
